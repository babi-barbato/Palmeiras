...
function sorteio(){
    ...
    if(jogador == 0 || jogador == 12){/*Faço isso para tirar o VS Estatistico */
        ...
        ftJogador.innerHTML = `<img src='../img/jogador-endrick.png'>`;
    }else if(jogador == 1){
        gifCarrega.style.display = "none";
        divJogador.innerHTML += `
        <h1>VOCÊ É O WEVERTON</h1>
        <p><a href="">Clique aqui</a> e descubra mais sobre ele</p>`;
        ftJogador.innerHTML = `<img src='../img/jogador-weverton.png'>`;
        ...
        <p><a href="">Clique aqui</a> e descubra mais sobre ele</p>`;
        ftJogador.innerHTML = `<img src='../img/jogador-marcosRocha.png'>`;
        ...
        <p><a href="">Clique aqui</a> e descubra mais sobre ele</p>`;
        ftJogador.innerHTML = `<img src='../img/jogador-murilo.png'>`;
        ...
        <p><a href="">Clique aqui</a> e descubra mais sobre ele</p>`;
        ftJogador.innerHTML = `<img src='../img/jogador-gustavoGomez.png'>`;
        ...
        <p><a href="">Clique aqui</a> e descubra mais sobre ele</p>`;
        ftJogador.innerHTML = `<img src='../img/jogador-gabrielMenino.png'>`;
        ...
        <h1>VOCÊ É O DUDU</h1>
        <p><a href="">Clique aqui</a> e descubra mais sobre ele</p>`;
        ftJogador.innerHTML = `<img src='../img/jogador-dudu.png'>`;
        ...
        <p><a href="">Clique aqui</a> e descubra mais sobre ele</p>`;
        ftJogador.innerHTML = `<img src='../img/jogador-arthur.png'>`;
